...
public class NullTerminatedGenerator {
	...
	public void printHeader(String elementClassname, ElementType elementType, LedgerEntry value) {
		...
		System.out.println("package " + Utilities.encodingPackageRoot + "Common.NullTerminatedArrays;");
	...
	public void processAccessorsMutatorsNode(LedgerEntry ledgerEntry) {
		...
		System.out.println();
		depthIncSpace();
		System.out.println(indentFormat + "byte[] byteArray = value;");
		...
		System.out.println();
		System.out.println(indentFormat + "this.value = newByteArray;");
		depthDecSpace();
		System.out.println(indentFormat + "}");
		System.out.println();
