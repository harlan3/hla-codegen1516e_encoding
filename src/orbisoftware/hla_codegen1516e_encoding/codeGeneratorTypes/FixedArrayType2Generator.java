...
public class FixedArrayType2Generator {
	...
	public void processAccessorsMutatorsNode(LedgerEntry ledgerEntry) {
		...
		System.out.println(indentFormat + "internalClassRepresentation[index] = " + variableName + ";");
	...
	public void processEncodeNode(LedgerEntry ledgerEntry) {
		...
		System.out.println(indentFormat + "internalClassRepresentation[i].encode(tmpBuffer, alignment);");
		System.out.println(indentFormat + "tmpBuffer.rewind();");
	...
	public void processDecodeNode(LedgerEntry ledgerEntry) {
		...
		System.out.println(indentFormat + "tmpBuffer.rewind();");
		System.out.println(indentFormat + "internalClassRepresentation[i].decode(tmpBuffer, alignment);");
